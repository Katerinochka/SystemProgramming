...
extern "C"
{
    ...
    __declspec(dllimport) void _stdcall InitSocket();
    __declspec(dllimport) int _stdcall GetCode();
    __declspec(dllimport) void _stdcall CreateSocketServer();
    __declspec(dllimport) void _stdcall ListenSocket();
    __declspec(dllimport) char* _stdcall GetString(int& num);
    __declspec(dllimport) void _stdcall SendCode(int code);
    __declspec(dllexport) void _stdcall Disconnect();
}
